...
for sample_size in sample_sizes:
    ...
    for hyperparam_folder in os.listdir(sample_dir):
        ...
        for seed_folder in os.listdir(hyperparam_dir):
            ...
            macro_f1 = val_results.loc[val_results['Unnamed: 0'] == 'macro', 'f1-score'].values[0]
    ...
    for seed_folder in os.listdir(best_hyperparam_dir):
        ...
        macro_precision = test_results.loc[test_results['Unnamed: 0'] == 'other', 'precision'].values[0]
        macro_recall = test_results.loc[test_results['Unnamed: 0'] == 'other', 'recall'].values[0]
        macro_f1 = test_results.loc[test_results['Unnamed: 0'] == 'other', 'f1-score'].values[0]
